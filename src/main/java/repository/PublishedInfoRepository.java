 ...
 */
public class PublishedInfoRepository extends BaseRepository {
     ...
     */
    public PublishedInfoRepository(HibernateFunctionExecutor hibernateFunctionExecutor) {
    ...
    public Optional<List<WriterInfoDto>> getWriterInfo(String code) {
